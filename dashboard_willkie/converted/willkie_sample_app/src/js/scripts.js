...
const CounterObjects = [
  new CounterObject(
    document.getElementById("emailStats"),
    255,
    5,
    30
  ),
  ...
  new CounterObject(
    document.getElementById("onlineUserStats"),
    410,
    10,
    30
  ),
  new CounterObject(
    document.getElementById("viewStats"),
    3312,
    12,
    0
  ),
  new CounterObject(
    document.getElementById("registeredUserStats"),
    6328,
    28,
    7
  ),
...
CounterObjects.forEach((co) => co.incrementCounter());